...
class raw_env(AECEnv, EzPickle):
    ...
    def sword_hit(self):
        for sword in self.sword_list:
            ...
            for zombie in zombie_sword_list:
                ...
                sword.knight.score += 1 + zombie.rect.y / 200
    ...
    def arrow_hit(self):
        for arrow in self.arrow_list:
            ...
            for zombie in zombie_arrow_list:
                ...
                arrow.archer.score += 1 + zombie.rect.y / 200
    ...
    def step(self, action):
        ...
        #print([zombie.rect.y for zombie in self.zombie_list])
    ...
    def reinit(self):
        ...
        for i in range(self.num_archers):
            ...
            self.archer_dict[f"archer{self.archer_player_num}"].offset(i * 250, 0)
        ...
        for i in range(self.num_knights):
            ...
            self.knight_dict[f"knight{self.knight_player_num}"].offset(i * 250, 0)
